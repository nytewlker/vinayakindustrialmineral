    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>47-B, Meera Nagar, Near Old RTO, Pratapnagar, Udaipur – 313003 (Raj). INDIA</p>


            </div>
            <div class="col-lg-2 col-md-6">
                <h5 class="text-white mb-4">Quick Links</h5>
                <a class="btn btn-link" href="index1.php">Home</a>
                <a class="btn btn-link" href="about.php">About Us</a>
                <a class="btn btn-link" href="certifications.php">Certifications</a>
                <a class="btn btn-link" href="infrastructure.php">Infrastructure</a>
                <a class="btn btn-link" href="applications.php">Applications</a>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link" href="product.php?product=dolomite-granules">Dolomite Granules</a>
                <a class="btn btn-link" href="product.php?product=soapstone-talc-powder">Soapstone And Talc Powder</a>
...
<div class="container-fluid copyright bg-dark py-4">
    <div class="container text-center">
        <p class="mb-2">Copyright &copy; <a class="fw-semi-bold" href="#">Vinayak Minerals</a>, All Right Reserved.
        </p>
        <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
        <p class="mb-0">Designed By <a class="fw-semi-bold" href="">Matrix Web Infotech</a></p>
    </div>
</div>
<!-- Copyright End -->
